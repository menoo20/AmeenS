      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">hello@aboameen.dev</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Available for remote collaboration</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium text-gray-900">Interests</h4>
                  <p className="text-gray-600">Education • Technology • Collaboration • Learning</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div className="mt-8">
              <h4 className="text-lg font-medium text-gray-900 mb-4">Follow My Journey</h4>
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-gray-100 text-gray-600 rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
