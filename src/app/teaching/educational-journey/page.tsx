    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Navigation Options */}
          <div className="flex flex-col sm:flex-row gap-6 justify-between items-center mt-16 mb-8 max-w-6xl mx-auto px-4">
            <Link 
              href="/teaching/starfield"
              className="group bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3 min-w-[280px] justify-center order-2 sm:order-1"
            >
            ...
            <Link 
              href="/teaching/certificates"
              className="group bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3 min-w-[280px] justify-center order-1 sm:order-2"
            >
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center group-hover:bg-white/30 transition-colors">
                <span className="text-xl">🎖️</span>
              </div>
              Browse Other Certificates
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center group-hover:translate-x-1 transition-transform">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
