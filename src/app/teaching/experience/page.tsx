                ...
                <div className={`grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <div className="sm:col-span-2 relative group">
                    ...
                    <Image
                      ...
                      width={800}
                      height={400}
                      className={`w-[90%] mx-auto h-auto object-cover rounded-lg shadow-xl transition-all duration-300 ${
                    ...
                    <>
                      <div className="relative group">
                        ...
                        <Image
                          ...
                          width={400}
                          height={200}
                          className={`w-[90%] mx-auto h-auto object-cover rounded-lg shadow-xl transition-all duration-300 group-hover:shadow-xl group-hover:scale-105 ${
