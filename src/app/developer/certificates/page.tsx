    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-700 via-blue-700 to-indigo-900 overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-24 sm:pt-28 md:pt-32 pb-32">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-6 sm:mb-8 text-center px-2">
          Programming Certificates & Courses
        </h1>
      ...
      <div className="fixed bottom-20 sm:bottom-24 md:bottom-8 left-4 right-4 sm:left-6 sm:right-6 md:left-8 md:right-8 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 pointer-events-none z-40">
        ...
        <button 
          ...
          className="w-full sm:w-auto bg-blue-600/90 hover:bg-blue-700 text-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-full font-bold text-sm sm:text-base shadow-lg transition-all duration-300 hover:scale-105 pointer-events-auto backdrop-blur-sm border border-white/20 flex items-center justify-center gap-2"
        >
